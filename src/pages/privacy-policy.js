      ...
      <div className="flex flex-col justify-center py-24 px-6">
        ...
        <div className="container mx-auto">
          ...
          <ol className="list-decimal list-inside privacy">
            ...
            <li className="main-list">IMPORTANT INFORMATION AND WHO WE ARE</li>
            <p className="sub-list">2.1. Purpose of this Privacy Notice.</p>
            <p>
            ...
            <p className="sub-list">2.2. Controller. </p>
            <p>
            ...
            <p className="sub-list">2.3. Changes to the Privacy Notice.</p>
            <p>
            ...
            <p className="sub-list">2.4. Third-party links.</p>
            <p>
            ...
            <li className="main-list">THE DATA WE COLLECT ABOUT YOU </li>
            <p>
            ...
            <p className="sub-list">3.1. Types of Personal Data.</p>
            <p>
          ...
          <div className="privacy">
            <h2 className="text-center py-12 text-4xl teal lowercase">
              PRIVACY NOTICE FOR CALIFORNIA AND NEVADA RESIDENTS
            </h2>
            <small>
