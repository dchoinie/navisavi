    ...
    return (
        ...
        <SEO title="Privacy Policy" />
        	<div className="">
        		...
        		<div className="">
        			<em>Last Updated: November 11, 2019</em>
        			<ol className="list-decimal list-inside privacy">
	        			<li className="main-list">INTRODUCTION</li>
	        			<p>Welcome to the Navi Savi (“Navi Savi”) Privacy Notice.</p>
	        			<p>
				        ...
				        <li className="">IMPORTANT INFORMATION AND WHO WE ARE</li>
				        <p className="">2.1. Purpose of this Privacy Notice.</p>
				        <p>
				        ...
				        <p className="">2.2. Controller. </p>
				        <p>
				        	Navi Savi, a Nebraska limited liability company, (collectively
				            referred to as “Navi Savi”, “we”, “us” or “our” in this Privacy
				        ...
				        <p className="">2.3. Changes to the Privacy Notice.</p>
				        <p>
				        ...
				        <p className="">2.4. Third-party links.</p>
				        <p>
				        ...
				        <li className="">THE DATA WE COLLECT ABOUT YOU </li>
				        <p>
				        ...
				        <p className="">3.1. Types of Personal Data.</p>
				        <p>
					        We may collect, use, store and transfer the following kinds of
					        personal data about you:
				        </p>
				        <p className="">
					        3.1.1 Identity Data includes first name, last name or similar
					        identifier, date of birth and gender.
				        </p>
				        <p className="">
					        3.1.2 Contact Data includes address, email address and telephone
					        numbers.
				        </p>
				        <p className="">
					        3.1.3 Financial Data includes bank account and payment card
					        details.
			        	</p>
				        <p className="">
					        3.1.4 Transaction Data includes details relating to a transaction,
					        such as payments to or from you.
				        </p>
				        <p className="">
					        3.1.5 Technical Data includes internet protocol (IP) address, your
				        ...
				        <p className="ml-12">
					        3.1.6 Profile Data, with respect to a Member or a pseudonymous
				        ...
				        <p className="ml-12">
					        3.1.7 Usage Data includes information about how you use our
					        Platform.
				        </p>
				        <p className="ml-12">
					        3.1.8 Marketing and Communications Data includes your preferences
				        ...
				        <li className="main-list">HOW IS YOUR PERSONAL DATA COLLECTED? </li>
				        <p>
					        We use different methods to collect data from and about you
					        including through:
				        </p>
				        <p className="sub-list">4.1. Direct interactions.</p>
				        <p>
				        ...
				        <p className="sub-list">4.2. Asutomated technologies or interactions.</p>
				        <p>
				        ...
				        <p className="sub-list">4.3. Third parties or publicly available sources.</p>
				        <p>
					        We may receive personal data about you from various third parties
					        as set out below:
				        </p>
				        <p className="ml-12">
					        4.3.1 Technical Data from analytics providers; advertising
					        networks; and search information providers.
				        </p>
				        <p className="ml-12">
					        4.3.2 Contact, Financial and Transaction Data from providers of
					        technical, payment and delivery services.
				        </p>
				        <p className="sub-list">4.4. Cookies. </p>
				        <p>
				        ...
				        <p>
					        A cookie is a small text file of letters and numbers that we store
			        	...
			        	<p>
					        ...
					        single-pixel gif) is a small electronic file that permits us, for
				        ...
				        <p className="sub-list">4.4.1 Strictly necessary cookies. </p>
				        <p>
					        These cookies are required for the operation of our Platform. Our
					        users cannot opt into or out of these cookies.
				        </p>
				        <p className="sub-list">4.4.2 Analytical/performance cookies.</p>
				        <p>
				        ...
				        <p className="sub-list">4.4.3 Functionality cookies.</p>
				        <p>
				        ...
				        <p className="sub-list">4.4.4 Targeting cookies. </p>
				        <p>
				        ...
				        <p className="sub-list">5.1. Fulfillment of Contract. </p>
				        <p>
				        ...
				        <p className="sub-list">5.2. Legitimate Interests.</p>
				        <p>
				        ...
				        <p className="sub-list">5.3. Compliance with Legal Obligations. </p>
				        <p>We may use your personal data to comply with a legal obligation.</p>
				        <p className="sub-list">5.4. Consent. </p>
				        <p>
					        Where we collect your consent, we may use your personal
					        information in any manner consistent with that consent.
				        </p>
				        <p className="sub-list">5.5. Marketing.</p>
				        <p>
				        ...
				        <p className="ml-12">
					        5.5.1 Promotional offers from us. We may use your Profile Data to
				        ...
				        <p className="ml-12">
					        5.5.2 Third-party marketing. We will collect your express opt-in
				        ...
				        <p className="ml-12">
					      	5.5.3 Opting out. You can opt out of (i) our disclosure of your
				      	...
				      	<p className="ml-12">
					      	5.5.4 “Do Not Sell My Personal Information”, or by using any
				      	...
				      	<p className="sub-list">5.6. Change of purpose.</p>
				      	<p>
				      	...
				      	<li className="main-list">DISCLOSURES OF YOUR PERSONAL DATA</li>
				      	...
				      	<li className="main-list">DATA SECURITY</li>
				      	<p>
				      	...
				      	<li className="main-list">DATA RETENTION </li>
				      	<p>
				      	...
				      	<li className="main-list">DATA ACCESS </li>
				      	<p className="sub-list">9.1. Your Rights. </p>
				      	<p>
				      	...
				      	<p className="sub-list">9.2. No fee normally required.</p>
				      	<p>
				      	...
				      	<p className="sub-list">9.4. Time limit to respond.</p>
				      	<p>
				      	...
				      	<p className="sub-list">9.5. Your California or Nevada Privacy Rights.</p>
				      	<p>
				      	...
				      	<p style={{ padding: "0" }}>Navi Savi, Attn: Data Privacy Manager</p>
				      	...
				      	<p className="sub-list">12.4. “Member” means a registered user of the Platform.</p>
				      	<p className="sub-list">
				      	...
				      	<p className="sub-list">
					      	...
					      	Listed Businesses’ use of the Platform, which are located at
					      	navisaviapp.com/tos.
				      	</p>
				      	<p className="sub-list">
					      	12.19. “Transaction” means each time that a Listed Business
			      	...
			      	<div className="privacy">
				      	<h2 className="text-center py-12 text-4xl teal lowercase">PRIVACY NOTICE FOR CALIFORNIA AND NEVADA RESIDENTS</h2>
				      	<em>Last updated on November 7, 2019 </em>
				      	<p>
					      	This Privacy Notice for California and Nevada Residents
					      	supplements the information contained in Navi Savi’s Privacy
			      		...
			      		<ol className="list-decimal list-inside">
					      	<li className="main-list">INFORMATION WE COLLECT </li>
					      	<p>
						    ...
						    <ul className="list-disc list-inside">
					      	...
					      	<p className="sub-list">4.2. Access to Specific Information and Data Portability Rights.</p>
					      	<p>
